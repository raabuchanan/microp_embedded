...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi){
	...
	if (hspi ->Instance == SPI1){
		...
		GPIO_InitStruct.Pin = LIS3DSH_SPI_SCK_PIN;
		HAL_GPIO_Init(LIS3DSH_SPI_SCK_GPIO_PORT, &GPIO_InitStruct);

		/* SPI  MOSI pin configuration */
		GPIO_InitStruct.Pin =  LIS3DSH_SPI_MOSI_PIN;
		HAL_GPIO_Init(LIS3DSH_SPI_MOSI_GPIO_PORT, &GPIO_InitStruct);

		/* SPI MISO pin configuration */
		GPIO_InitStruct.Pin = LIS3DSH_SPI_MISO_PIN;
		HAL_GPIO_Init(LIS3DSH_SPI_MISO_GPIO_PORT, &GPIO_InitStruct);
		...
		GPIO_InitStruct.Pin   = LIS3DSH_SPI_INT1_PIN;
		GPIO_InitStruct.Mode  = GPIO_MODE_IT_FALLING;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
		HAL_GPIO_Init(LIS3DSH_SPI_INT1_GPIO_PORT, &GPIO_InitStruct);
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN; // PULLDOWN might work too
    GPIO_InitStruct.Speed = GPIO_SPEED_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
